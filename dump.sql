...
ALTER TABLE ONLY public.likes
    ADD CONSTRAINT "likes_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."user"(id);


--
-- Name: posts posts_likesId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT "posts_likesId_fkey" FOREIGN KEY ("likesId") REFERENCES public.likes(id);


--
-- Name: posts posts_tagId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.posts
    ADD CONSTRAINT "posts_tagId_fkey" FOREIGN KEY ("tagId") REFERENCES public.hashtags(id);
...
ALTER TABLE ONLY public.posts
    ADD CONSTRAINT "posts_userId_fkey" FOREIGN KEY ("userId") REFERENCES public."user"(id);
